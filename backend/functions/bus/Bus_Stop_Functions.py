...
class Bus_Stop_Finder:
    ...
    def __init__(self):
        self.bus_routes = pd.read_csv("misc/Bus_Routes.csv")
        self.bus_services = pd.read_csv("misc/Bus_Services.csv")
        self.bus_stops = pd.read_csv("misc/Bus_Stops.csv")
        self.passenger_vol_feb = pd.read_csv("misc/transport_node_bus_202402.csv")
    ...
    def find_crowded_stops(self, nearby_stops_df):
        ...
        filtered_passenger_volume = self.passenger_vol_feb[self.passenger_vol_feb['PT_CODE'].isin(nearby_stops_codes)]
    ...
    def chart_bus_route(self, route_details, target_coords):
        ...
        """
        singapore_map = gpd.read_file('../../misc/RoadSectionLine.shp')
...
# bus_routes = pd.read_csv("../../misc/Bus_Routes.csv")
# bus_services = pd.read_csv("../../misc/Bus_Services.csv")
# bus_stops = pd.read_csv("../../misc/Bus_Stops.csv")
# passenger_vol_feb = pd.read_csv("../../misc/transport_node_bus_202402.csv")
